...
public class JA_SmartContract_DynamicAll extends CustomJavaAction<IMendixObject>
{
	...
	public JA_SmartContract_DynamicAll(
		IContext context,
...
//		throw new com.mendix.systemwideinterfaces.MendixRuntimeException("Java action was not implemented");
	...
	{
		return "JA_SmartContract_DynamicAll";
	}
...
//        PlutusData datum = ConstrPlutusData.of(0, BytesPlutusData.of(paymentCredentialHash.toString()));
        ...
        Result<String> result;
			...
			result = quickTxBuilder.compose(scriptTx)
			        ...
			        .withSigner(SignerProviders.signerFrom(SecretKey.create(this.SenderWallet.getSKey().getBytes())))
