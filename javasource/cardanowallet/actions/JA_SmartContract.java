...
public class JA_SmartContract extends CustomJavaAction<java.lang.String>
{
	public JA_SmartContract(IContext context)
	{
		super(context);
	}
	...
	// BEGIN EXTRA CODE
	 ...
	 private String senderAddress = sender.baseAddress();
	 ...
	 private Account sender2 = new Account(Networks.testnet(), senderMnemonic2);
	 private String senderAddress2 = sender2.baseAddress();
...
//	    BackendService backendService = new BFBackendService("http://localhost:8080/api/v1/", "Dummy Key");
	...
	public String invokeContract() throws Exception {
